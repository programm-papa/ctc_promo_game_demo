        ...
        levelData: {
          ...
          animal: {
            ...
            mainLoopCallback: function (event, animal, animalTrigger, mouthWals) {
              ...
              if (Common.now() - this.lastChange > 33) {
          ...
          obstacles: [
            {
              ...
              mainLoopCallback: function (event, body) {
                ...
                const addVal = (this.invertMove ? -1 : 1) * (0.015 * this.width)
  ...
  
            {
              ...
              size: [0.7, 0.05], // width, height
              slope: 0.5, // clope for trapezoid
              sprites: ['/obstacles/arm-left.png'],
              currentSprite: 0,
              spriteScale: [1, 1],
              isStatic: true,
              restitution: 1, // bouncing effect 0..1
            ...
            },
            {
              ...
              size: [0.7, 0.05], // width, height
              slope: 0.5, // clope for trapezoid
              sprites: ['/obstacles/leg-left.png'],
              currentSprite: 0,
              spriteScale: [1, 1],
              isStatic: true,
              restitution: 1, // bouncing effect 0..1
